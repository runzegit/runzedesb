...
class Cliente(models.Model):
	...
	datDesb = models.DateField(verbose_name = "Último Desbloqueio",)
	datPag = models.DateField(verbose_name = "Data Últ. Pag.", blank=True, null=True)
	mesRef = models.IntegerField(verbose_name = "Mês Referência",)
	diaVen = models.IntegerField(verbose_name = "Dia Vencimento",)
